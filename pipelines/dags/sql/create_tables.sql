...
-- COPY dim_dates FROM '/opt/airflow/dags/data/dim_dates.tsv' DELIMITER E'\t' CSV HEADER;
-- COPY dim_dates FROM '/opt/airflow/dags/sql/dim_dates.tsv' DELIMITER E'\t' CSV HEADER;
-- COPY dim_status FROM '/opt/airflow/dags/data/dim_status.tsv' DELIMITER E'\t' CSV HEADER;
-- COPY dim_origins FROM '/opt/airflow/dags/data/dim_origins.tsv' DELIMITER E'\t' CSV HEADER;
-- COPY dim_safeness_gv FROM '/opt/airflow/dags/data/dim_safeness.tsv' DELIMITER E'\t' CSV HEADER;
-- COPY meme_facts FROM '/opt/airflow/dags/data/fact_table_memes.tsv' DELIMITER E'\t' CSV HEADER;
